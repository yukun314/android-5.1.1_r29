...
public class Workspace extends SmoothPagedView
    ...
    /**
     * Hotseat 是否响应事件
     * @return true 响应事件  false不响应事件
     */
    public boolean HotseatInModalState(){
        //FIXME 根据需要再修改
        // workspace(NORMAL)界面和所有App(NORMAL_HIDDEN)界面 都响应事件
        return mState != State.NORMAL && mState != State.NORMAL_HIDDEN;
    }
...
//        mLauncher.setDragController(true);
    ...
    public void onDrop(final DragObject d) {
        mDragViewVisualCenter = mDragUtils.getDragViewVisualCenter(d.x, d.y, d.xOffset, d.yOffset, d.dragView,
                mDragViewVisualCenter, getResources());
    ...
    public void onDragOver(DragObject d) {
        ...
        if (mDragTargetLayout != null) {
            ...
            if (!nearestDropOccupied) {
                ...
                mDragUtils.mReorderAlarm.setAlarm(REORDER_TIMEOUT);
            }

            if (mDragUtils.mDragMode == mDragUtils.DRAG_MODE_CREATE_FOLDER || mDragUtils.mDragMode == mDragUtils.DRAG_MODE_ADD_TO_FOLDER ||
                    !nearestDropOccupied) {
                if (mDragTargetLayout != null) {
                    mDragTargetLayout.revertTempState();
                }
    ...
    private void onDropExternal(final int[] touchXY, final Object dragInfo,
        ...
        if (info instanceof PendingAddItemInfo) {
            ...
            if (pendingInfo.itemType == LauncherSettings.Favorites.ITEM_TYPE_SHORTCUT) {
                mTargetCell = mDragUtils.findNearestArea((int) touchXY[0], (int) touchXY[1], spanX, spanY,
    ...
    public void setWorkspaceEnabled(boolean isEnabled){
        isWorkspaceEnabled = isEnabled;
    }
