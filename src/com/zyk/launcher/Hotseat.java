...
public class Hotseat extends FrameLayout {
    ...
    private AllAppsButton allAppsButton;

    //allAppsButton 在不同状态时显示的图标
    private Drawable mAllAppsIcon; //在workspace显示时，此时点击进入allapps界面
    private Drawable mWorkspaceIcon;//在allapps显示时，此时点击进入workspace界面
    private Drawable mToWorkspaceIcon;//在sllapps界面长按图标后显示，图标拖拽到此处 走添加快捷方式流程，
    ...
    protected void onFinishInflate() {
        ...
        mAllAppsIcon = resources.getDrawable(R.drawable.all_apps_button_icon);
        Utilities.resizeIconDrawable(mAllAppsIcon);
        mWorkspaceIcon = resources.getDrawable(R.drawable.workspace_button_icon);
        Utilities.resizeIconDrawable(mWorkspaceIcon);
        //FIXME 暂时还没用到
//        mToWorkspaceIcon = resources.getDrawable(R.drawable.);
//        Utilities.resizeIconDrawable(mToWorkspaceIcon);
    ...
    void resetLayout() {
        ...
        if (!LauncherAppState.isDisableAllApps()) {
            ...
            allAppsButton.setCompoundDrawables(null, mAllAppsIcon, null, null);
            ...
            if (mLauncher != null) {
                ...
                mLauncher.getDragController().addDropTarget(allAppsButton);
            }
     ...
     * 设置AllAppsButton的图标
     */
    public void setAllAppsButtonDrawable(){
        if(mLauncher.isAllAppsVisible()) {
            allAppsButton.setCompoundDrawables(null, mWorkspaceIcon, null, null);
        }else {
            allAppsButton.setCompoundDrawables(null, mAllAppsIcon, null, null);
        }
    }
    ...
    public boolean onInterceptTouchEvent(MotionEvent ev) {
        ...
        // the normal state.
        if (mLauncher.getWorkspace().HotseatInModalState()) {
            return true;
        }
        return false;
    }
