...
public class LauncherSettings {
    ...
    public static final class Allapps implements BaseLauncherColumns {
         ...
         */
        static final Uri CONTENT_URI = Uri.parse("content://" +
                LauncherProvider.AUTHORITY + "/" + LauncherProvider.TABLE_ALLAPPS +
                "?" + LauncherProvider.PARAMETER_NOTIFY + "=true");
         ...
         * The icon is a resource identified by a package name and an integer id.
         */
        static final int CONTAINER_ALLAPPS = -102;

        static final String containerToString(int container) {
            switch (container) {
                case CONTAINER_ALLAPPS: return "allapps";
                default: return String.valueOf(container);
            }
        }

        /**
         * The screen holding the allapps (if container is CONTAINER_DESKTOP)
         * <P>Type: INTEGER</P>
         */
        static final String SCREEN_ID = "screen";

        /**
         * The X coordinate of the cell holding the allapps
        ...
        /**
         * The Y coordinate of the cell holding the allapps
        ...
        /**
         * The X span of the cell holding the allapps
         * <P>Type: INTEGER</P>
         */
        static final String SPANX = "spanX";

        /**
         * The Y span of the cell holding the allapps
         * <P>Type: INTEGER</P>
         */
        ...
        /**
         * The allapps is a user created folder
         */
        static final int ITEM_TYPE_FOLDER = 2;

        /**
         * The allapps is a live folder
         *
        ...
        /**
         * The allapps is a widget
         */
        static final int ITEM_TYPE_APPWIDGET = 4;

        /**
         * The allapps is a clock
         */
        static final int ITEM_TYPE_WIDGET_CLOCK = 1000;

        /**
         * The allapps is a search widget
         */
        static final int ITEM_TYPE_WIDGET_SEARCH = 1001;

        /**
         * The allapps is a photo frame
         */
        ...
        /**
         * Indicates whether this allapps is an application-created shortcut or not.
         * If the value is 0, the allapps is not an application-created shortcut, if the
        ...
        /**
         * The URI associated with the allapps. It is used, for instance, by
