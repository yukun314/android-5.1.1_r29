...
public class DragController {
    ...
    private void drop(float x, float y) {
        ...
        if (dropTarget != null) {
            ...
            if (dropTarget.acceptDrop(mDragObject)) {//接受你手上的图标
    ...
    public void addDropTargetAtLast(DropTarget target){
        mDropTargets.add(mDropTargets.size(),target);
    }
